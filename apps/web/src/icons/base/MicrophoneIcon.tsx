...
function MicrophoneIcon(
  ...
  return (
    <svg
      ...
      width={props.size || '24'}
      viewBox={calcViewBox({ x1: 5, y1: 2, x2: 19, y2: 22 })}
    ...
    >
      ...
      <path
        d="M12 2a3 3 0 00-3 3v6a3 3 0 006 0V5a3 3 0 00-3-3zM5 10v1a7 7 0 0014 0v-1M12 18v4M8 22h8"
        stroke="currentColor"
...
export default forwardRef(MicrophoneIcon);
